# write_eml() writes an eml to the given directory
    ...
    Output
      ...
      [2] "<![CDATA[<span></span>Data have been standardized to Darwin Core using the https://inbo.github.io/camtrapdp/\">camtrapdp</a> R package and only include observations (and associated media) of animals. Excluded are records that document blank or unclassified media, vehicles and observations of humans.]]>"                                                                                                                                                               
...
---
    ...
    Output
      ...
      dataset:
        ...
        title: 'Sample from: MICA - Muskrat and coypu camera trap observations in Belgium,
        ...
        abstract:
          ...
          - <![CDATA[<span></span>Data have been standardized to Darwin Core using the https://inbo.github.io/camtrapdp/">camtrapdp</a>
          ...
          designDescription:
            description:
              para: This project uses a targeted sampling design. Animals are unmarked and
                camera traps are triggered with activity detection and time lapse.
        creator:
        - individualName:
            givenName: Emma
            surName: Cartuyvels
