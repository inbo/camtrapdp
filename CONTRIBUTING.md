...
First of all, thanks for considering contributing to camtrapdp! 👍 It’s
people like you that make it rewarding for us - the project
maintainers - to work on camtrapdp. 😊

camtrapdp is an open source project, maintained by people who care. We
...
Think camtrapdp is useful? Let others discover it, by telling them in
person, via Twitter or a blog post.

Using camtrapdp for a paper you are writing? Consider [citing
it](https://inbo.github.io/camtrapdp/authors.html).

### Ask a question ⁉️

Using camtrapdp and got stuck? Browse the
[documentation](https://inbo.github.io/camtrapdp) to see if you can find
a solution. Still stuck? Post your question as an [issue on
GitHub](https://github.com/inbo/camtrapdp/issues/new). While we cannot
...
Have an idea for a new camtrapdp feature? Take a look at the
[documentation](https://inbo.github.io/camtrapdp) and [issue
list](https://github.com/inbo/camtrapdp/issues) to see if it isn’t
included or suggested yet. If not, suggest your idea as an [issue on
GitHub](https://github.com/inbo/camtrapdp/issues/new). While we can’t
...
Using camtrapdp and discovered a bug? That’s annoying! Don’t let others
have the same experience and report it as an [issue on
GitHub](https://github.com/inbo/camtrapdp/issues/new) so we can fix it.
...
[This website](https://inbo.github.io/camtrapdp) is generated with
...
issue](https://github.com/inbo/camtrapdp/issues/new) and we can point
...
1.  Go to `R/` directory in the [code
    repository](https://github.com/inbo/camtrapdp).
...
Care to fix bugs or implement new functionality for camtrapdp? Awesome!
👏 Have a look at the [issue
list](https://github.com/inbo/camtrapdp/issues) and leave a comment on
...
1.  Fork [this repo](https://github.com/inbo/camtrapdp) and clone it to
